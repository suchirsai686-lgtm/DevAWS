      ...
      <main>
        ...
        <section className="scd-section" style={{ borderTop: '1px solid rgba(255,255,255,.05)' }}>
          ...
          <div className="scd-container" style={{ position: 'relative' }}>
            ...
            <div className="text-center">
              <a className="gradient-btn" href="https://docs.google.com/forms/d/e/1FAIpQLSfcUjvg0TKfsh-xuB3USrnTiD24vVCnwgJWUqzr7UENCBvEnw/viewform?usp=header" target="_blank" rel="noopener noreferrer"><div className="btn-bg" /><div className="btn-bg-hover" /><span>Become a Sponsor</span><ArrowRight size={20} /></a>
          ...
          <div className="scd-container">
            ...
            <div className="experience-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)', maxWidth: 640, margin: '0 auto' }}>
              <div className="glass-card">
                ...
                <h3>Siddhardha</h3>
                <p style={{ marginBottom: 12 }}>AWS MECS Coordinators</p>
